  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">About Bespoke Baby Store</h1>
        ...
        <div className="prose max-w-none">
          ...
          <ul>
            <li>
              <strong>Quality:</strong> We only offer products that we would use for our own children.
            </li>
            <li>
              <strong>Safety:</strong> All our products meet or exceed safety standards.
            </li>
            <li>
              <strong>Affordability:</strong> We believe quality baby products should be accessible to all families.
            </li>
            <li>
              <strong>Customer Service:</strong> We're here to support you throughout your parenting journey.
            </li>
          </ul>
