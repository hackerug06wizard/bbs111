        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                <a href="tel:+256784973404" className="hover:text-primary">
                  +256 784 973404
                </a>
              </p>
              <p className="text-muted-foreground">
                <a href="tel:+256783468608" className="hover:text-primary">
                  +256 783 468608
                </a>
              </p>
            </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                <a href="mailto:info@bespokebabystore.com" className="hover:text-primary">
