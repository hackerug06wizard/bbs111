      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>What materials are your baby bottles made from?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>How do I clean and sterilize the baby bottles?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-6">
            <AccordionTrigger>How do I know which bottle size is right for my baby?</AccordionTrigger>
            <AccordionContent>
